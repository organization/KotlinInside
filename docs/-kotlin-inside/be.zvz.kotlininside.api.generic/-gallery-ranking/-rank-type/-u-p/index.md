...
| [compareTo](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-enum/compare-to.html)| [jvm]  <br>Content  <br>operator override fun [compareTo](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-enum/compare-to.html)(other: [GalleryRanking.RankType](../index.md)): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)  <br><br><br>
...
|  Name|  Summary| 
|---|---|
| [name](index.md#be.zvz.kotlininside.api.generic/GalleryRanking.RankType.UP/name/#/PointingToDeclaration/)|  [jvm] override val [name](index.md#be.zvz.kotlininside.api.generic/GalleryRanking.RankType.UP/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [ordinal](index.md#be.zvz.kotlininside.api.generic/GalleryRanking.RankType.UP/ordinal/#/PointingToDeclaration/)|  [jvm] override val [ordinal](index.md#be.zvz.kotlininside.api.generic/GalleryRanking.RankType.UP/ordinal/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>

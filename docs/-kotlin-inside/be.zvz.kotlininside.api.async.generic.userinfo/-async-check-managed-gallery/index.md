...
/[AsyncCheckManagedGallery](index.md)

# AsyncCheckManagedGallery

[jvm] class [AsyncCheckManagedGallery](index.md)(**
...
| <a name="be.zvz.kotlininside.api.async.generic.userinfo/AsyncCheckManagedGallery/requestAsync/#/PointingToDeclaration/"></a>[requestAsync](request-async.md)| <a name="be.zvz.kotlininside.api.async.generic.userinfo/AsyncCheckManagedGallery/requestAsync/#/PointingToDeclaration/"></a>[jvm]  <br>Content  <br>suspend fun [requestAsync](request-async.md)(): Deferred<[CheckManagedGallery.CheckResult](../../be.zvz.kotlininside.api.generic.userinfo/-check-managed-gallery/-check-result/index.md)>  <br><br><br>

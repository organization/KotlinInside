...
/[AsyncCheckJoinedMiniGallery](index.md)

# AsyncCheckJoinedMiniGallery

[jvm] class [AsyncCheckJoinedMiniGallery](index.md)(**
...
| <a name="be.zvz.kotlininside.api.async.generic.userinfo/AsyncCheckJoinedMiniGallery/requestAsync/#/PointingToDeclaration/"></a>[requestAsync](request-async.md)| <a name="be.zvz.kotlininside.api.async.generic.userinfo/AsyncCheckJoinedMiniGallery/requestAsync/#/PointingToDeclaration/"></a>[jvm]  <br>Content  <br>suspend fun [requestAsync](request-async.md)(): Deferred<[CheckJoinedMiniGallery.CheckResult](../../be.zvz.kotlininside.api.generic.userinfo/-check-joined-mini-gallery/-check-result/index.md)>  <br><br><br>

...
|  Name|  Summary| 
|---|---|
| [name](index.md#be.zvz.kotlininside.api.article/ArticleList.SearchType.SUBJECT_AND_CONTENT/name/#/PointingToDeclaration/)|  [jvm] override val [name](index.md#be.zvz.kotlininside.api.article/ArticleList.SearchType.SUBJECT_AND_CONTENT/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [ordinal](index.md#be.zvz.kotlininside.api.article/ArticleList.SearchType.SUBJECT_AND_CONTENT/ordinal/#/PointingToDeclaration/)|  [jvm] override val [ordinal](index.md#be.zvz.kotlininside.api.article/ArticleList.SearchType.SUBJECT_AND_CONTENT/ordinal/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
| [type](index.md#be.zvz.kotlininside.api.article/ArticleList.SearchType.SUBJECT_AND_CONTENT/type/#/PointingToDeclaration/)|  [jvm] override val [type](index.md#be.zvz.kotlininside.api.article/ArticleList.SearchType.SUBJECT_AND_CONTENT/type/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>

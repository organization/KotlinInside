...
|  Name|  Summary| 
|---|---|
| <a name="be.zvz.kotlininside.session.user/LoginUser/id/#/PointingToDeclaration/"></a>[id](id.md)| <a name="be.zvz.kotlininside.session.user/LoginUser/id/#/PointingToDeclaration/"></a> [jvm] open override val [id](id.md): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| <a name="be.zvz.kotlininside.session.user/LoginUser/password/#/PointingToDeclaration/"></a>[password](password.md)| <a name="be.zvz.kotlininside.session.user/LoginUser/password/#/PointingToDeclaration/"></a> [jvm] open override val [password](password.md): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
...
|  Name| 
|---|
| <a name="be.zvz.kotlininside.session.user.named/DuplicateNamed///PointingToDeclaration/"></a>[DuplicateNamed](../../be.zvz.kotlininside.session.user.named/-duplicate-named/index.md)
| <a name="be.zvz.kotlininside.session.user.named/Named///PointingToDeclaration/"></a>[Named](../../be.zvz.kotlininside.session.user.named/-named/index.md)

...
|  Name|  Summary| 
|---|---|
| <a name="be.zvz.kotlininside.session.user/User/id/#/PointingToDeclaration/"></a>[id](id.md)| <a name="be.zvz.kotlininside.session.user/User/id/#/PointingToDeclaration/"></a> [jvm] abstract val [id](id.md): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| <a name="be.zvz.kotlininside.session.user/User/password/#/PointingToDeclaration/"></a>[password](password.md)| <a name="be.zvz.kotlininside.session.user/User/password/#/PointingToDeclaration/"></a> [jvm] abstract val [password](password.md): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
...
|  Name| 
|---|
| <a name="be.zvz.kotlininside.session.user/Anonymous///PointingToDeclaration/"></a>[Anonymous](../-anonymous/index.md)
| <a name="be.zvz.kotlininside.session.user/LoginUser///PointingToDeclaration/"></a>[LoginUser](../-login-user/index.md)

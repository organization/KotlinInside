...
|  Name|  Summary| 
|---|---|
| [name](index.md#be.zvz.kotlininside.session.user/UserType.NAMED/name/#/PointingToDeclaration/)|  [jvm] override val [name](index.md#be.zvz.kotlininside.session.user/UserType.NAMED/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [ordinal](index.md#be.zvz.kotlininside.session.user/UserType.NAMED/ordinal/#/PointingToDeclaration/)|  [jvm] override val [ordinal](index.md#be.zvz.kotlininside.session.user/UserType.NAMED/ordinal/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
| [stype](index.md#be.zvz.kotlininside.session.user/UserType.NAMED/stype/#/PointingToDeclaration/)|  [jvm] override val [stype](index.md#be.zvz.kotlininside.session.user/UserType.NAMED/stype/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>

...
|  Name|  Summary| 
|---|---|
| [name](index.md#be.zvz.kotlininside.session.user/UserType.ANONYMOUS/name/#/PointingToDeclaration/)|  [jvm] override val [name](index.md#be.zvz.kotlininside.session.user/UserType.ANONYMOUS/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [ordinal](index.md#be.zvz.kotlininside.session.user/UserType.ANONYMOUS/ordinal/#/PointingToDeclaration/)|  [jvm] override val [ordinal](index.md#be.zvz.kotlininside.session.user/UserType.ANONYMOUS/ordinal/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
| [stype](index.md#be.zvz.kotlininside.session.user/UserType.ANONYMOUS/stype/#/PointingToDeclaration/)|  [jvm] override val [stype](index.md#be.zvz.kotlininside.session.user/UserType.ANONYMOUS/stype/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>

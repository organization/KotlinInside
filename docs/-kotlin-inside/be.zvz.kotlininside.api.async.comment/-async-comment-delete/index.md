...
---
//[KotlinInside](../../index.md)/[be.zvz.kotlininside.api.async.comment](../index.md)/[AsyncCommentDelete](index.md)
...
|  Name|  Summary| 
|---|---|
| <a name="be.zvz.kotlininside.api.async.comment/AsyncCommentDelete/deleteAsync/#/PointingToDeclaration/"></a>[deleteAsync](delete-async.md)| <a name="be.zvz.kotlininside.api.async.comment/AsyncCommentDelete/deleteAsync/#/PointingToDeclaration/"></a>[jvm]  <br>Content  <br>suspend fun [deleteAsync](delete-async.md)(): Deferred<[CommentDelete.DeleteResult](../../be.zvz.kotlininside.api.comment/-comment-delete/-delete-result/index.md)>  <br><br><br>

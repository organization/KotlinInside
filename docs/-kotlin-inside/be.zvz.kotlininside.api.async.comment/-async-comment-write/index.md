...
---
//[KotlinInside](../../index.md)/[be.zvz.kotlininside.api.async.comment](../index.md)/[AsyncCommentWrite](index.md)
...
| <a name="be.zvz.kotlininside.api.async.comment/AsyncCommentWrite/replyAsync/#kotlin.Int/PointingToDeclaration/"></a>[replyAsync](reply-async.md)| <a name="be.zvz.kotlininside.api.async.comment/AsyncCommentWrite/replyAsync/#kotlin.Int/PointingToDeclaration/"></a>[jvm]  <br>Content  <br>suspend fun [replyAsync](reply-async.md)(commentId: [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)): Deferred<[CommentWrite.WriteResult](../../be.zvz.kotlininside.api.comment/-comment-write/-write-result/index.md)>  <br><br><br>
...
| <a name="be.zvz.kotlininside.api.async.comment/AsyncCommentWrite/writeAsync/#/PointingToDeclaration/"></a>[writeAsync](write-async.md)| <a name="be.zvz.kotlininside.api.async.comment/AsyncCommentWrite/writeAsync/#/PointingToDeclaration/"></a>[jvm]  <br>Content  <br>suspend fun [writeAsync](write-async.md)(): Deferred<[CommentWrite.WriteResult](../../be.zvz.kotlininside.api.comment/-comment-write/-write-result/index.md)>  <br><br><br>

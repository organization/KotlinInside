...
---
//[KotlinInside](../../index.md)/[be.zvz.kotlininside.api.async.generic](../index.md)/[AsyncMinorGalleryInfo](index.md)



# AsyncMinorGalleryInfo  
 [jvm] class [AsyncMinorGalleryInfo](index.md)(**gallId**: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html))   
...
| <a name="be.zvz.kotlininside.api.async.generic/AsyncMinorGalleryInfo/getAsync/#/PointingToDeclaration/"></a>[getAsync](get-async.md)| <a name="be.zvz.kotlininside.api.async.generic/AsyncMinorGalleryInfo/getAsync/#/PointingToDeclaration/"></a>[jvm]  <br>Content  <br>suspend fun [getAsync](get-async.md)(): Deferred<[MinorGalleryInfo.InfoResult](../../be.zvz.kotlininside.api.generic/-minor-gallery-info/-info-result/index.md)>  <br><br><br>

...
---
//[KotlinInside](../../index.md)/[be.zvz.kotlininside.api.async.generic](../index.md)/[AsyncTotalSearch](index.md)



# AsyncTotalSearch  
 [jvm] class [AsyncTotalSearch](index.md)(**keyword**: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html))   
...
| <a name="be.zvz.kotlininside.api.async.generic/AsyncTotalSearch/searchAsync/#/PointingToDeclaration/"></a>[searchAsync](search-async.md)| <a name="be.zvz.kotlininside.api.async.generic/AsyncTotalSearch/searchAsync/#/PointingToDeclaration/"></a>[jvm]  <br>Content  <br>suspend fun [searchAsync](search-async.md)(): Deferred<[TotalSearch.TotalSearchResult](../../be.zvz.kotlininside.api.generic/-total-search/-total-search-result/index.md)>  <br><br><br>
